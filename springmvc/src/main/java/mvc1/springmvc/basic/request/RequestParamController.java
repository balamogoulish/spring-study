...
public class RequestParamController {
    ...
    /**
     * @RequestParam 사용
     * 파라미터 이름과 변수명이 같은 경우 @RequestParam("파라미터명") -> @RequestParam으로 생략 가능
     */
    @ResponseBody
    ...
    /**
     * @RequestParam 사용
     * String, int 등의 단순 타입인 경우 @RequestParam도 생략 가능
     */
    @ResponseBody
     ...
     * required=true인 parameter가 없으면 예외 발생
     ...
     * 파라미터의 값이 1개가 확실하지 않은 경우는  MultiValueMap 사용!!
     */
    @ResponseBody
    ...
    /**
     * @ModelAttribute 사용
     * ModelAttribute 사용 시, 해당 객체로 setter를 호출해서 파라미터의 값을 바인딩(입력)한다.
     */
    @ResponseBody
