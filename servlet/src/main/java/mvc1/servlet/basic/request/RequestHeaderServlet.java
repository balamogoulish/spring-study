...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        System.out.println();
        System.out.println("[Accept-Language Utils]"); request.getLocales().asIterator()
                .forEachRemaining(locale -> System.out.println("locale = " +
                        locale));
        System.out.println("request.getLocale() = " + request.getLocale()); System.out.println();
        System.out.println("[cookie Utils]"); if (request.getCookies() != null) {
    ...
    private void printEtc(HttpServletRequest request) {
        ...
        System.out.println("--- ETC end ---"); System.out.println();
    }
}
